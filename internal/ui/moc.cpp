...
public:
	...
	void Signal_CheckTxDiff() { callbackApproveTxCtx721036_CheckTxDiff(this); };
	...
	void Signal_ChangeValueUnit(qint32 v) { callbackApproveTxCtx721036_ChangeValueUnit(this, v); };
	void Signal_ChangeGasPriceUnit(qint32 v) { callbackApproveTxCtx721036_ChangeGasPriceUnit(this, v); };
	qreal valueUnit() { return callbackApproveTxCtx721036_ValueUnit(this); };
	void setValueUnit(qreal valueUnit) { callbackApproveTxCtx721036_SetValueUnit(this, valueUnit); };
	void Signal_ValueUnitChanged(qreal valueUnit) { callbackApproveTxCtx721036_ValueUnitChanged(this, valueUnit); };
	...
	qreal gasPriceUnit() { return callbackApproveTxCtx721036_GasPriceUnit(this); };
	void setGasPriceUnit(qreal gasPriceUnit) { callbackApproveTxCtx721036_SetGasPriceUnit(this, gasPriceUnit); };
	void Signal_GasPriceUnitChanged(qreal gasPriceUnit) { callbackApproveTxCtx721036_GasPriceUnitChanged(this, gasPriceUnit); };
	...
	QString diff() { return ({ Moc_PackedString tempVal = callbackApproveTxCtx721036_Diff(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setDiff(QString diff) { QByteArray t75a0ee = diff.toUtf8(); Moc_PackedString diffPacked = { const_cast<char*>(t75a0ee.prepend("WHITESPACE").constData()+10), t75a0ee.size()-10 };callbackApproveTxCtx721036_SetDiff(this, diffPacked); };
	void Signal_DiffChanged(QString diff) { QByteArray t75a0ee = diff.toUtf8(); Moc_PackedString diffPacked = { const_cast<char*>(t75a0ee.prepend("WHITESPACE").constData()+10), t75a0ee.size()-10 };callbackApproveTxCtx721036_DiffChanged(this, diffPacked); };
...
Q_PROPERTY(QString selectedAddress READ selectedAddress WRITE setSelectedAddress NOTIFY selectedAddressChanged)
public:
	...
	QString selectedAddress() { return ({ Moc_PackedString tempVal = callbackTxListModel721036_SelectedAddress(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setSelectedAddress(QString selectedAddress) { QByteArray tfd188b = selectedAddress.toUtf8(); Moc_PackedString selectedAddressPacked = { const_cast<char*>(tfd188b.prepend("WHITESPACE").constData()+10), tfd188b.size()-10 };callbackTxListModel721036_SetSelectedAddress(this, selectedAddressPacked); };
	void Signal_SelectedAddressChanged(QString selectedAddress) { QByteArray tfd188b = selectedAddress.toUtf8(); Moc_PackedString selectedAddressPacked = { const_cast<char*>(tfd188b.prepend("WHITESPACE").constData()+10), tfd188b.size()-10 };callbackTxListModel721036_SelectedAddressChanged(this, selectedAddressPacked); };
	...
	QString selectedAddressDefault() { return _selectedAddress; };
	void setSelectedAddressDefault(QString p) { if (p != _selectedAddress) { _selectedAddress = p; selectedAddressChanged(_selectedAddress); } };
signals:
	void clear();
	void add(quintptr tx);
	void remove(qint32 i);
	void isEmptyChanged(bool isEmpty);
	void selectedAddressChanged(QString selectedAddress);
public slots:
private:
	bool _isEmpty;
	QString _selectedAddress;
};
...
public:
	...
	void Signal_AccountChanged(qint32 b) { callbackTxListCtx721036_AccountChanged(this, b); };
	QString shortenAddress() { return ({ Moc_PackedString tempVal = callbackTxListCtx721036_ShortenAddress(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setShortenAddress(QString shortenAddress) { QByteArray t3fdf7b = shortenAddress.toUtf8(); Moc_PackedString shortenAddressPacked = { const_cast<char*>(t3fdf7b.prepend("WHITESPACE").constData()+10), t3fdf7b.size()-10 };callbackTxListCtx721036_SetShortenAddress(this, shortenAddressPacked); };
	void Signal_ShortenAddressChanged(QString shortenAddress) { QByteArray t3fdf7b = shortenAddress.toUtf8(); Moc_PackedString shortenAddressPacked = { const_cast<char*>(t3fdf7b.prepend("WHITESPACE").constData()+10), t3fdf7b.size()-10 };callbackTxListCtx721036_ShortenAddressChanged(this, shortenAddressPacked); };
	QString selectedAddress() { return ({ Moc_PackedString tempVal = callbackTxListCtx721036_SelectedAddress(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setSelectedAddress(QString selectedAddress) { QByteArray tfd188b = selectedAddress.toUtf8(); Moc_PackedString selectedAddressPacked = { const_cast<char*>(tfd188b.prepend("WHITESPACE").constData()+10), tfd188b.size()-10 };callbackTxListCtx721036_SetSelectedAddress(this, selectedAddressPacked); };
	void Signal_SelectedAddressChanged(QString selectedAddress) { QByteArray tfd188b = selectedAddress.toUtf8(); Moc_PackedString selectedAddressPacked = { const_cast<char*>(tfd188b.prepend("WHITESPACE").constData()+10), tfd188b.size()-10 };callbackTxListCtx721036_SelectedAddressChanged(this, selectedAddressPacked); };
	QString selectedSrc() { return ({ Moc_PackedString tempVal = callbackTxListCtx721036_SelectedSrc(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setSelectedSrc(QString selectedSrc) { QByteArray t5f7742 = selectedSrc.toUtf8(); Moc_PackedString selectedSrcPacked = { const_cast<char*>(t5f7742.prepend("WHITESPACE").constData()+10), t5f7742.size()-10 };callbackTxListCtx721036_SetSelectedSrc(this, selectedSrcPacked); };
	void Signal_SelectedSrcChanged(QString selectedSrc) { QByteArray t5f7742 = selectedSrc.toUtf8(); Moc_PackedString selectedSrcPacked = { const_cast<char*>(t5f7742.prepend("WHITESPACE").constData()+10), t5f7742.size()-10 };callbackTxListCtx721036_SelectedSrcChanged(this, selectedSrcPacked); };
...
void ApproveTxCtx721036_ConnectCheckTxDiff(void* ptr)
{
	QObject::connect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)()>(&ApproveTxCtx721036::checkTxDiff), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)()>(&ApproveTxCtx721036::Signal_CheckTxDiff));
}

void ApproveTxCtx721036_DisconnectCheckTxDiff(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)()>(&ApproveTxCtx721036::checkTxDiff), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)()>(&ApproveTxCtx721036::Signal_CheckTxDiff));
}

void ApproveTxCtx721036_CheckTxDiff(void* ptr)
{
	static_cast<ApproveTxCtx721036*>(ptr)->checkTxDiff();
}
...
{
	QObject::connect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::changeValueUnit), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::Signal_ChangeValueUnit));
}

void ApproveTxCtx721036_DisconnectChangeValueUnit(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::changeValueUnit), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::Signal_ChangeValueUnit));
}

void ApproveTxCtx721036_ChangeValueUnit(void* ptr, int v)
{
	static_cast<ApproveTxCtx721036*>(ptr)->changeValueUnit(v);
}

void ApproveTxCtx721036_ConnectChangeGasPriceUnit(void* ptr)
{
	QObject::connect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::changeGasPriceUnit), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::Signal_ChangeGasPriceUnit));
}

void ApproveTxCtx721036_DisconnectChangeGasPriceUnit(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::changeGasPriceUnit), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qint32)>(&ApproveTxCtx721036::Signal_ChangeGasPriceUnit));
}

void ApproveTxCtx721036_ChangeGasPriceUnit(void* ptr, int v)
{
	static_cast<ApproveTxCtx721036*>(ptr)->changeGasPriceUnit(v);
}

double ApproveTxCtx721036_ValueUnit(void* ptr)
{
	return static_cast<ApproveTxCtx721036*>(ptr)->valueUnit();
}

double ApproveTxCtx721036_ValueUnitDefault(void* ptr)
{
	return static_cast<ApproveTxCtx721036*>(ptr)->valueUnitDefault();
}

void ApproveTxCtx721036_SetValueUnit(void* ptr, double valueUnit)
{
	static_cast<ApproveTxCtx721036*>(ptr)->setValueUnit(valueUnit);
}

void ApproveTxCtx721036_SetValueUnitDefault(void* ptr, double valueUnit)
{
	static_cast<ApproveTxCtx721036*>(ptr)->setValueUnitDefault(valueUnit);
}

void ApproveTxCtx721036_ConnectValueUnitChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::valueUnitChanged), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::Signal_ValueUnitChanged));
}

void ApproveTxCtx721036_DisconnectValueUnitChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::valueUnitChanged), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::Signal_ValueUnitChanged));
}

void ApproveTxCtx721036_ValueUnitChanged(void* ptr, double valueUnit)
{
	static_cast<ApproveTxCtx721036*>(ptr)->valueUnitChanged(valueUnit);
}
...
{
	return static_cast<ApproveTxCtx721036*>(ptr)->gasPriceUnit();
}

double ApproveTxCtx721036_GasPriceUnitDefault(void* ptr)
{
	return static_cast<ApproveTxCtx721036*>(ptr)->gasPriceUnitDefault();
}

void ApproveTxCtx721036_SetGasPriceUnit(void* ptr, double gasPriceUnit)
{
	static_cast<ApproveTxCtx721036*>(ptr)->setGasPriceUnit(gasPriceUnit);
}

void ApproveTxCtx721036_SetGasPriceUnitDefault(void* ptr, double gasPriceUnit)
{
	static_cast<ApproveTxCtx721036*>(ptr)->setGasPriceUnitDefault(gasPriceUnit);
}

void ApproveTxCtx721036_ConnectGasPriceUnitChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::gasPriceUnitChanged), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::Signal_GasPriceUnitChanged));
}

void ApproveTxCtx721036_DisconnectGasPriceUnitChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::gasPriceUnitChanged), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(qreal)>(&ApproveTxCtx721036::Signal_GasPriceUnitChanged));
}

void ApproveTxCtx721036_GasPriceUnitChanged(void* ptr, double gasPriceUnit)
{
	static_cast<ApproveTxCtx721036*>(ptr)->gasPriceUnitChanged(gasPriceUnit);
}
...
struct Moc_PackedString ApproveTxCtx721036_Diff(void* ptr)
{
	return ({ QByteArray t81763e = static_cast<ApproveTxCtx721036*>(ptr)->diff().toUtf8(); Moc_PackedString { const_cast<char*>(t81763e.prepend("WHITESPACE").constData()+10), t81763e.size()-10 }; });
}

struct Moc_PackedString ApproveTxCtx721036_DiffDefault(void* ptr)
{
	return ({ QByteArray td180f6 = static_cast<ApproveTxCtx721036*>(ptr)->diffDefault().toUtf8(); Moc_PackedString { const_cast<char*>(td180f6.prepend("WHITESPACE").constData()+10), td180f6.size()-10 }; });
}

void ApproveTxCtx721036_SetDiff(void* ptr, struct Moc_PackedString diff)
{
	static_cast<ApproveTxCtx721036*>(ptr)->setDiff(QString::fromUtf8(diff.data, diff.len));
}

void ApproveTxCtx721036_SetDiffDefault(void* ptr, struct Moc_PackedString diff)
{
	static_cast<ApproveTxCtx721036*>(ptr)->setDiffDefault(QString::fromUtf8(diff.data, diff.len));
}

void ApproveTxCtx721036_ConnectDiffChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(QString)>(&ApproveTxCtx721036::diffChanged), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(QString)>(&ApproveTxCtx721036::Signal_DiffChanged));
}

void ApproveTxCtx721036_DisconnectDiffChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(QString)>(&ApproveTxCtx721036::diffChanged), static_cast<ApproveTxCtx721036*>(ptr), static_cast<void (ApproveTxCtx721036::*)(QString)>(&ApproveTxCtx721036::Signal_DiffChanged));
}

void ApproveTxCtx721036_DiffChanged(void* ptr, struct Moc_PackedString diff)
{
	static_cast<ApproveTxCtx721036*>(ptr)->diffChanged(QString::fromUtf8(diff.data, diff.len));
}
...
{
	QObject::connect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(qint32)>(&TxListCtx721036::accountChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(qint32)>(&TxListCtx721036::Signal_AccountChanged));
}

void TxListCtx721036_DisconnectAccountChanged(void* ptr)
{
	QObject::disconnect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(qint32)>(&TxListCtx721036::accountChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(qint32)>(&TxListCtx721036::Signal_AccountChanged));
}

void TxListCtx721036_AccountChanged(void* ptr, int b)
{
	static_cast<TxListCtx721036*>(ptr)->accountChanged(b);
}

struct Moc_PackedString TxListCtx721036_ShortenAddress(void* ptr)
{
	return ({ QByteArray tf699cf = static_cast<TxListCtx721036*>(ptr)->shortenAddress().toUtf8(); Moc_PackedString { const_cast<char*>(tf699cf.prepend("WHITESPACE").constData()+10), tf699cf.size()-10 }; });
}

struct Moc_PackedString TxListCtx721036_ShortenAddressDefault(void* ptr)
{
	return ({ QByteArray tde87a5 = static_cast<TxListCtx721036*>(ptr)->shortenAddressDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tde87a5.prepend("WHITESPACE").constData()+10), tde87a5.size()-10 }; });
}

void TxListCtx721036_SetShortenAddress(void* ptr, struct Moc_PackedString shortenAddress)
{
	static_cast<TxListCtx721036*>(ptr)->setShortenAddress(QString::fromUtf8(shortenAddress.data, shortenAddress.len));
}

void TxListCtx721036_SetShortenAddressDefault(void* ptr, struct Moc_PackedString shortenAddress)
{
	static_cast<TxListCtx721036*>(ptr)->setShortenAddressDefault(QString::fromUtf8(shortenAddress.data, shortenAddress.len));
}

void TxListCtx721036_ConnectShortenAddressChanged(void* ptr)
{
	QObject::connect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::shortenAddressChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::Signal_ShortenAddressChanged));
}

void TxListCtx721036_DisconnectShortenAddressChanged(void* ptr)
{
	QObject::disconnect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::shortenAddressChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::Signal_ShortenAddressChanged));
}

void TxListCtx721036_ShortenAddressChanged(void* ptr, struct Moc_PackedString shortenAddress)
{
	static_cast<TxListCtx721036*>(ptr)->shortenAddressChanged(QString::fromUtf8(shortenAddress.data, shortenAddress.len));
}

struct Moc_PackedString TxListCtx721036_SelectedAddress(void* ptr)
{
	return ({ QByteArray t143de8 = static_cast<TxListCtx721036*>(ptr)->selectedAddress().toUtf8(); Moc_PackedString { const_cast<char*>(t143de8.prepend("WHITESPACE").constData()+10), t143de8.size()-10 }; });
}

struct Moc_PackedString TxListCtx721036_SelectedAddressDefault(void* ptr)
{
	return ({ QByteArray tba9842 = static_cast<TxListCtx721036*>(ptr)->selectedAddressDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tba9842.prepend("WHITESPACE").constData()+10), tba9842.size()-10 }; });
}

void TxListCtx721036_SetSelectedAddress(void* ptr, struct Moc_PackedString selectedAddress)
{
	static_cast<TxListCtx721036*>(ptr)->setSelectedAddress(QString::fromUtf8(selectedAddress.data, selectedAddress.len));
}

void TxListCtx721036_SetSelectedAddressDefault(void* ptr, struct Moc_PackedString selectedAddress)
{
	static_cast<TxListCtx721036*>(ptr)->setSelectedAddressDefault(QString::fromUtf8(selectedAddress.data, selectedAddress.len));
}

void TxListCtx721036_ConnectSelectedAddressChanged(void* ptr)
{
	QObject::connect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::selectedAddressChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::Signal_SelectedAddressChanged));
}

void TxListCtx721036_DisconnectSelectedAddressChanged(void* ptr)
{
	QObject::disconnect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::selectedAddressChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::Signal_SelectedAddressChanged));
}

void TxListCtx721036_SelectedAddressChanged(void* ptr, struct Moc_PackedString selectedAddress)
{
	static_cast<TxListCtx721036*>(ptr)->selectedAddressChanged(QString::fromUtf8(selectedAddress.data, selectedAddress.len));
}

struct Moc_PackedString TxListCtx721036_SelectedSrc(void* ptr)
{
	return ({ QByteArray tff7988 = static_cast<TxListCtx721036*>(ptr)->selectedSrc().toUtf8(); Moc_PackedString { const_cast<char*>(tff7988.prepend("WHITESPACE").constData()+10), tff7988.size()-10 }; });
}

struct Moc_PackedString TxListCtx721036_SelectedSrcDefault(void* ptr)
{
	return ({ QByteArray te8fe51 = static_cast<TxListCtx721036*>(ptr)->selectedSrcDefault().toUtf8(); Moc_PackedString { const_cast<char*>(te8fe51.prepend("WHITESPACE").constData()+10), te8fe51.size()-10 }; });
}

void TxListCtx721036_SetSelectedSrc(void* ptr, struct Moc_PackedString selectedSrc)
{
	static_cast<TxListCtx721036*>(ptr)->setSelectedSrc(QString::fromUtf8(selectedSrc.data, selectedSrc.len));
}

void TxListCtx721036_SetSelectedSrcDefault(void* ptr, struct Moc_PackedString selectedSrc)
{
	static_cast<TxListCtx721036*>(ptr)->setSelectedSrcDefault(QString::fromUtf8(selectedSrc.data, selectedSrc.len));
}

void TxListCtx721036_ConnectSelectedSrcChanged(void* ptr)
{
	QObject::connect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::selectedSrcChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::Signal_SelectedSrcChanged));
}

void TxListCtx721036_DisconnectSelectedSrcChanged(void* ptr)
{
	QObject::disconnect(static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::selectedSrcChanged), static_cast<TxListCtx721036*>(ptr), static_cast<void (TxListCtx721036::*)(QString)>(&TxListCtx721036::Signal_SelectedSrcChanged));
}

void TxListCtx721036_SelectedSrcChanged(void* ptr, struct Moc_PackedString selectedSrc)
{
	static_cast<TxListCtx721036*>(ptr)->selectedSrcChanged(QString::fromUtf8(selectedSrc.data, selectedSrc.len));
}
...
{
	return ({ QByteArray tca77ca = static_cast<TxListModel721036*>(ptr)->selectedAddress().toUtf8(); Moc_PackedString { const_cast<char*>(tca77ca.prepend("WHITESPACE").constData()+10), tca77ca.size()-10 }; });
}

struct Moc_PackedString TxListModel721036_SelectedAddressDefault(void* ptr)
{
	return ({ QByteArray tec9184 = static_cast<TxListModel721036*>(ptr)->selectedAddressDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tec9184.prepend("WHITESPACE").constData()+10), tec9184.size()-10 }; });
}

void TxListModel721036_SetSelectedAddress(void* ptr, struct Moc_PackedString selectedAddress)
{
	static_cast<TxListModel721036*>(ptr)->setSelectedAddress(QString::fromUtf8(selectedAddress.data, selectedAddress.len));
}

void TxListModel721036_SetSelectedAddressDefault(void* ptr, struct Moc_PackedString selectedAddress)
{
	static_cast<TxListModel721036*>(ptr)->setSelectedAddressDefault(QString::fromUtf8(selectedAddress.data, selectedAddress.len));
}

void TxListModel721036_ConnectSelectedAddressChanged(void* ptr)
{
	QObject::connect(static_cast<TxListModel721036*>(ptr), static_cast<void (TxListModel721036::*)(QString)>(&TxListModel721036::selectedAddressChanged), static_cast<TxListModel721036*>(ptr), static_cast<void (TxListModel721036::*)(QString)>(&TxListModel721036::Signal_SelectedAddressChanged));
}

void TxListModel721036_DisconnectSelectedAddressChanged(void* ptr)
{
	QObject::disconnect(static_cast<TxListModel721036*>(ptr), static_cast<void (TxListModel721036::*)(QString)>(&TxListModel721036::selectedAddressChanged), static_cast<TxListModel721036*>(ptr), static_cast<void (TxListModel721036::*)(QString)>(&TxListModel721036::Signal_SelectedAddressChanged));
}

void TxListModel721036_SelectedAddressChanged(void* ptr, struct Moc_PackedString selectedAddress)
{
	static_cast<TxListModel721036*>(ptr)->selectedAddressChanged(QString::fromUtf8(selectedAddress.data, selectedAddress.len));
}
