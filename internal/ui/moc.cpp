...
class ApproveExportCtx77da62: public QObject
{
Q_OBJECT
...
public:
	ApproveExportCtx77da62(QObject *parent = Q_NULLPTR) : QObject(parent) {qRegisterMetaType<quintptr>("quintptr");ApproveExportCtx77da62_ApproveExportCtx77da62_QRegisterMetaType();ApproveExportCtx77da62_ApproveExportCtx77da62_QRegisterMetaTypes();callbackApproveExportCtx77da62_Constructor(this);};
	void Signal_Clicked(qint32 b) { callbackApproveExportCtx77da62_Clicked(this, b); };
	void Signal_Back() { callbackApproveExportCtx77da62_Back(this); };
	void Signal_PasswordEdited(QString b) { QByteArray te9d71f = b.toUtf8(); Moc_PackedString bPacked = { const_cast<char*>(te9d71f.prepend("WHITESPACE").constData()+10), te9d71f.size()-10 };callbackApproveExportCtx77da62_PasswordEdited(this, bPacked); };
	QString remote() { return ({ Moc_PackedString tempVal = callbackApproveExportCtx77da62_Remote(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setRemote(QString remote) { QByteArray t41ffe5 = remote.toUtf8(); Moc_PackedString remotePacked = { const_cast<char*>(t41ffe5.prepend("WHITESPACE").constData()+10), t41ffe5.size()-10 };callbackApproveExportCtx77da62_SetRemote(this, remotePacked); };
	void Signal_RemoteChanged(QString remote) { QByteArray t41ffe5 = remote.toUtf8(); Moc_PackedString remotePacked = { const_cast<char*>(t41ffe5.prepend("WHITESPACE").constData()+10), t41ffe5.size()-10 };callbackApproveExportCtx77da62_RemoteChanged(this, remotePacked); };
	QString transport() { return ({ Moc_PackedString tempVal = callbackApproveExportCtx77da62_Transport(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setTransport(QString transport) { QByteArray ta8e601 = transport.toUtf8(); Moc_PackedString transportPacked = { const_cast<char*>(ta8e601.prepend("WHITESPACE").constData()+10), ta8e601.size()-10 };callbackApproveExportCtx77da62_SetTransport(this, transportPacked); };
	void Signal_TransportChanged(QString transport) { QByteArray ta8e601 = transport.toUtf8(); Moc_PackedString transportPacked = { const_cast<char*>(ta8e601.prepend("WHITESPACE").constData()+10), ta8e601.size()-10 };callbackApproveExportCtx77da62_TransportChanged(this, transportPacked); };
	QString endpoint() { return ({ Moc_PackedString tempVal = callbackApproveExportCtx77da62_Endpoint(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setEndpoint(QString endpoint) { QByteArray te13fe4 = endpoint.toUtf8(); Moc_PackedString endpointPacked = { const_cast<char*>(te13fe4.prepend("WHITESPACE").constData()+10), te13fe4.size()-10 };callbackApproveExportCtx77da62_SetEndpoint(this, endpointPacked); };
	void Signal_EndpointChanged(QString endpoint) { QByteArray te13fe4 = endpoint.toUtf8(); Moc_PackedString endpointPacked = { const_cast<char*>(te13fe4.prepend("WHITESPACE").constData()+10), te13fe4.size()-10 };callbackApproveExportCtx77da62_EndpointChanged(this, endpointPacked); };
	QString address() { return ({ Moc_PackedString tempVal = callbackApproveExportCtx77da62_Address(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setAddress(QString address) { QByteArray tc66218 = address.toUtf8(); Moc_PackedString addressPacked = { const_cast<char*>(tc66218.prepend("WHITESPACE").constData()+10), tc66218.size()-10 };callbackApproveExportCtx77da62_SetAddress(this, addressPacked); };
	void Signal_AddressChanged(QString address) { QByteArray tc66218 = address.toUtf8(); Moc_PackedString addressPacked = { const_cast<char*>(tc66218.prepend("WHITESPACE").constData()+10), tc66218.size()-10 };callbackApproveExportCtx77da62_AddressChanged(this, addressPacked); };
	QString password() { return ({ Moc_PackedString tempVal = callbackApproveExportCtx77da62_Password(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setPassword(QString password) { QByteArray t5baa61 = password.toUtf8(); Moc_PackedString passwordPacked = { const_cast<char*>(t5baa61.prepend("WHITESPACE").constData()+10), t5baa61.size()-10 };callbackApproveExportCtx77da62_SetPassword(this, passwordPacked); };
	void Signal_PasswordChanged(QString password) { QByteArray t5baa61 = password.toUtf8(); Moc_PackedString passwordPacked = { const_cast<char*>(t5baa61.prepend("WHITESPACE").constData()+10), t5baa61.size()-10 };callbackApproveExportCtx77da62_PasswordChanged(this, passwordPacked); };
	QString fromSrc() { return ({ Moc_PackedString tempVal = callbackApproveExportCtx77da62_FromSrc(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setFromSrc(QString fromSrc) { QByteArray ta8ded4 = fromSrc.toUtf8(); Moc_PackedString fromSrcPacked = { const_cast<char*>(ta8ded4.prepend("WHITESPACE").constData()+10), ta8ded4.size()-10 };callbackApproveExportCtx77da62_SetFromSrc(this, fromSrcPacked); };
	void Signal_FromSrcChanged(QString fromSrc) { QByteArray ta8ded4 = fromSrc.toUtf8(); Moc_PackedString fromSrcPacked = { const_cast<char*>(ta8ded4.prepend("WHITESPACE").constData()+10), ta8ded4.size()-10 };callbackApproveExportCtx77da62_FromSrcChanged(this, fromSrcPacked); };
	 ~ApproveExportCtx77da62() { callbackApproveExportCtx77da62_DestroyApproveExportCtx(this); };
	bool event(QEvent * e) { return callbackApproveExportCtx77da62_Event(this, e) != 0; };
	bool eventFilter(QObject * watched, QEvent * event) { return callbackApproveExportCtx77da62_EventFilter(this, watched, event) != 0; };
	void childEvent(QChildEvent * event) { callbackApproveExportCtx77da62_ChildEvent(this, event); };
	void connectNotify(const QMetaMethod & sign) { callbackApproveExportCtx77da62_ConnectNotify(this, const_cast<QMetaMethod*>(&sign)); };
	void customEvent(QEvent * event) { callbackApproveExportCtx77da62_CustomEvent(this, event); };
	void deleteLater() { callbackApproveExportCtx77da62_DeleteLater(this); };
	void Signal_Destroyed(QObject * obj) { callbackApproveExportCtx77da62_Destroyed(this, obj); };
	void disconnectNotify(const QMetaMethod & sign) { callbackApproveExportCtx77da62_DisconnectNotify(this, const_cast<QMetaMethod*>(&sign)); };
	void Signal_ObjectNameChanged(const QString & objectName) { QByteArray taa2c4f = objectName.toUtf8(); Moc_PackedString objectNamePacked = { const_cast<char*>(taa2c4f.prepend("WHITESPACE").constData()+10), taa2c4f.size()-10 };callbackApproveExportCtx77da62_ObjectNameChanged(this, objectNamePacked); };
	void timerEvent(QTimerEvent * event) { callbackApproveExportCtx77da62_TimerEvent(this, event); };
...
Q_DECLARE_METATYPE(ApproveExportCtx77da62*)


void ApproveExportCtx77da62_ApproveExportCtx77da62_QRegisterMetaTypes() {
...
class ApproveImportCtx77da62: public QObject
{
Q_OBJECT
Q_PROPERTY(QString remote READ remote WRITE setRemote NOTIFY remoteChanged)
Q_PROPERTY(QString transport READ transport WRITE setTransport NOTIFY transportChanged)
...
public:
	ApproveImportCtx77da62(QObject *parent = Q_NULLPTR) : QObject(parent) {qRegisterMetaType<quintptr>("quintptr");ApproveImportCtx77da62_ApproveImportCtx77da62_QRegisterMetaType();ApproveImportCtx77da62_ApproveImportCtx77da62_QRegisterMetaTypes();callbackApproveImportCtx77da62_Constructor(this);};
	void Signal_Clicked(qint32 b) { callbackApproveImportCtx77da62_Clicked(this, b); };
	void Signal_Back() { callbackApproveImportCtx77da62_Back(this); };
	void Signal_PasswordEdited(QString b) { QByteArray te9d71f = b.toUtf8(); Moc_PackedString bPacked = { const_cast<char*>(te9d71f.prepend("WHITESPACE").constData()+10), te9d71f.size()-10 };callbackApproveImportCtx77da62_PasswordEdited(this, bPacked); };
	void Signal_ConfirmPasswordEdited(QString b) { QByteArray te9d71f = b.toUtf8(); Moc_PackedString bPacked = { const_cast<char*>(te9d71f.prepend("WHITESPACE").constData()+10), te9d71f.size()-10 };callbackApproveImportCtx77da62_ConfirmPasswordEdited(this, bPacked); };
	void Signal_OldPasswordEdited(QString b) { QByteArray te9d71f = b.toUtf8(); Moc_PackedString bPacked = { const_cast<char*>(te9d71f.prepend("WHITESPACE").constData()+10), te9d71f.size()-10 };callbackApproveImportCtx77da62_OldPasswordEdited(this, bPacked); };
	QString remote() { return ({ Moc_PackedString tempVal = callbackApproveImportCtx77da62_Remote(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setRemote(QString remote) { QByteArray t41ffe5 = remote.toUtf8(); Moc_PackedString remotePacked = { const_cast<char*>(t41ffe5.prepend("WHITESPACE").constData()+10), t41ffe5.size()-10 };callbackApproveImportCtx77da62_SetRemote(this, remotePacked); };
	void Signal_RemoteChanged(QString remote) { QByteArray t41ffe5 = remote.toUtf8(); Moc_PackedString remotePacked = { const_cast<char*>(t41ffe5.prepend("WHITESPACE").constData()+10), t41ffe5.size()-10 };callbackApproveImportCtx77da62_RemoteChanged(this, remotePacked); };
	QString transport() { return ({ Moc_PackedString tempVal = callbackApproveImportCtx77da62_Transport(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setTransport(QString transport) { QByteArray ta8e601 = transport.toUtf8(); Moc_PackedString transportPacked = { const_cast<char*>(ta8e601.prepend("WHITESPACE").constData()+10), ta8e601.size()-10 };callbackApproveImportCtx77da62_SetTransport(this, transportPacked); };
	void Signal_TransportChanged(QString transport) { QByteArray ta8e601 = transport.toUtf8(); Moc_PackedString transportPacked = { const_cast<char*>(ta8e601.prepend("WHITESPACE").constData()+10), ta8e601.size()-10 };callbackApproveImportCtx77da62_TransportChanged(this, transportPacked); };
	QString endpoint() { return ({ Moc_PackedString tempVal = callbackApproveImportCtx77da62_Endpoint(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setEndpoint(QString endpoint) { QByteArray te13fe4 = endpoint.toUtf8(); Moc_PackedString endpointPacked = { const_cast<char*>(te13fe4.prepend("WHITESPACE").constData()+10), te13fe4.size()-10 };callbackApproveImportCtx77da62_SetEndpoint(this, endpointPacked); };
	void Signal_EndpointChanged(QString endpoint) { QByteArray te13fe4 = endpoint.toUtf8(); Moc_PackedString endpointPacked = { const_cast<char*>(te13fe4.prepend("WHITESPACE").constData()+10), te13fe4.size()-10 };callbackApproveImportCtx77da62_EndpointChanged(this, endpointPacked); };
	QString oldPassword() { return ({ Moc_PackedString tempVal = callbackApproveImportCtx77da62_OldPassword(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setOldPassword(QString oldPassword) { QByteArray t9a8cf4 = oldPassword.toUtf8(); Moc_PackedString oldPasswordPacked = { const_cast<char*>(t9a8cf4.prepend("WHITESPACE").constData()+10), t9a8cf4.size()-10 };callbackApproveImportCtx77da62_SetOldPassword(this, oldPasswordPacked); };
	void Signal_OldPasswordChanged(QString oldPassword) { QByteArray t9a8cf4 = oldPassword.toUtf8(); Moc_PackedString oldPasswordPacked = { const_cast<char*>(t9a8cf4.prepend("WHITESPACE").constData()+10), t9a8cf4.size()-10 };callbackApproveImportCtx77da62_OldPasswordChanged(this, oldPasswordPacked); };
	QString password() { return ({ Moc_PackedString tempVal = callbackApproveImportCtx77da62_Password(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setPassword(QString password) { QByteArray t5baa61 = password.toUtf8(); Moc_PackedString passwordPacked = { const_cast<char*>(t5baa61.prepend("WHITESPACE").constData()+10), t5baa61.size()-10 };callbackApproveImportCtx77da62_SetPassword(this, passwordPacked); };
	void Signal_PasswordChanged(QString password) { QByteArray t5baa61 = password.toUtf8(); Moc_PackedString passwordPacked = { const_cast<char*>(t5baa61.prepend("WHITESPACE").constData()+10), t5baa61.size()-10 };callbackApproveImportCtx77da62_PasswordChanged(this, passwordPacked); };
	QString confirmPassword() { return ({ Moc_PackedString tempVal = callbackApproveImportCtx77da62_ConfirmPassword(this); QString ret = QString::fromUtf8(tempVal.data, tempVal.len); free(tempVal.data); ret; }); };
	void setConfirmPassword(QString confirmPassword) { QByteArray t802b53 = confirmPassword.toUtf8(); Moc_PackedString confirmPasswordPacked = { const_cast<char*>(t802b53.prepend("WHITESPACE").constData()+10), t802b53.size()-10 };callbackApproveImportCtx77da62_SetConfirmPassword(this, confirmPasswordPacked); };
	void Signal_ConfirmPasswordChanged(QString confirmPassword) { QByteArray t802b53 = confirmPassword.toUtf8(); Moc_PackedString confirmPasswordPacked = { const_cast<char*>(t802b53.prepend("WHITESPACE").constData()+10), t802b53.size()-10 };callbackApproveImportCtx77da62_ConfirmPasswordChanged(this, confirmPasswordPacked); };
	 ~ApproveImportCtx77da62() { callbackApproveImportCtx77da62_DestroyApproveImportCtx(this); };
	bool event(QEvent * e) { return callbackApproveImportCtx77da62_Event(this, e) != 0; };
	bool eventFilter(QObject * watched, QEvent * event) { return callbackApproveImportCtx77da62_EventFilter(this, watched, event) != 0; };
	void childEvent(QChildEvent * event) { callbackApproveImportCtx77da62_ChildEvent(this, event); };
	void connectNotify(const QMetaMethod & sign) { callbackApproveImportCtx77da62_ConnectNotify(this, const_cast<QMetaMethod*>(&sign)); };
	void customEvent(QEvent * event) { callbackApproveImportCtx77da62_CustomEvent(this, event); };
	void deleteLater() { callbackApproveImportCtx77da62_DeleteLater(this); };
	void Signal_Destroyed(QObject * obj) { callbackApproveImportCtx77da62_Destroyed(this, obj); };
	void disconnectNotify(const QMetaMethod & sign) { callbackApproveImportCtx77da62_DisconnectNotify(this, const_cast<QMetaMethod*>(&sign)); };
	void Signal_ObjectNameChanged(const QString & objectName) { QByteArray taa2c4f = objectName.toUtf8(); Moc_PackedString objectNamePacked = { const_cast<char*>(taa2c4f.prepend("WHITESPACE").constData()+10), taa2c4f.size()-10 };callbackApproveImportCtx77da62_ObjectNameChanged(this, objectNamePacked); };
	void timerEvent(QTimerEvent * event) { callbackApproveImportCtx77da62_TimerEvent(this, event); };
	QString remoteDefault() { return _remote; };
	void setRemoteDefault(QString p) { if (p != _remote) { _remote = p; remoteChanged(_remote); } };
	QString transportDefault() { return _transport; };
	void setTransportDefault(QString p) { if (p != _transport) { _transport = p; transportChanged(_transport); } };
...
Q_DECLARE_METATYPE(ApproveImportCtx77da62*)


void ApproveImportCtx77da62_ApproveImportCtx77da62_QRegisterMetaTypes() {
	qRegisterMetaType<QString>();
}
...
public:
	...
	void Signal_Clicked(qint32 b) { callbackApproveListingCtx77da62_Clicked(this, b); };
...
public:
	...
	void Signal_Back() { callbackApproveSignDataCtx77da62_Back(this); };
...
{
Q_OBJECT
Q_PROPERTY(qreal valueUnit READ valueUnit WRITE setValueUnit NOTIFY valueUnitChanged)
Q_PROPERTY(QString remote READ remote WRITE setRemote NOTIFY remoteChanged)
Q_PROPERTY(QString transport READ transport WRITE setTransport NOTIFY transportChanged)
Q_PROPERTY(QString endpoint READ endpoint WRITE setEndpoint NOTIFY endpointChanged)
...
Q_PROPERTY(qreal gasPriceUnit READ gasPriceUnit WRITE setGasPriceUnit NOTIFY gasPriceUnitChanged)
...
public:
	...
	void Signal_Clicked(qint32 b) { callbackApproveTxCtx77da62_Clicked(this, b); };
	...
	qreal valueUnit() { return callbackApproveTxCtx77da62_ValueUnit(this); };
	void setValueUnit(qreal valueUnit) { callbackApproveTxCtx77da62_SetValueUnit(this, valueUnit); };
	void Signal_ValueUnitChanged(qreal valueUnit) { callbackApproveTxCtx77da62_ValueUnitChanged(this, valueUnit); };
	...
	qreal gasPriceUnit() { return callbackApproveTxCtx77da62_GasPriceUnit(this); };
	void setGasPriceUnit(qreal gasPriceUnit) { callbackApproveTxCtx77da62_SetGasPriceUnit(this, gasPriceUnit); };
	void Signal_GasPriceUnitChanged(qreal gasPriceUnit) { callbackApproveTxCtx77da62_GasPriceUnitChanged(this, gasPriceUnit); };
	...
	qreal valueUnitDefault() { return _valueUnit; };
	void setValueUnitDefault(qreal p) { if (p != _valueUnit) { _valueUnit = p; valueUnitChanged(_valueUnit); } };
	QString remoteDefault() { return _remote; };
	void setRemoteDefault(QString p) { if (p != _remote) { _remote = p; remoteChanged(_remote); } };
	QString transportDefault() { return _transport; };
	void setTransportDefault(QString p) { if (p != _transport) { _transport = p; transportChanged(_transport); } };
	...
	qreal gasPriceUnitDefault() { return _gasPriceUnit; };
	void setGasPriceUnitDefault(qreal p) { if (p != _gasPriceUnit) { _gasPriceUnit = p; gasPriceUnitChanged(_gasPriceUnit); } };
...
signals:
	...
	void valueUnitChanged(qreal valueUnit);
	void remoteChanged(QString remote);
	void transportChanged(QString transport);
	void endpointChanged(QString endpoint);
	...
	void gasPriceUnitChanged(qreal gasPriceUnit);
...
void ApproveExportCtx77da62_ConnectClicked(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(qint32)>(&ApproveExportCtx77da62::clicked), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(qint32)>(&ApproveExportCtx77da62::Signal_Clicked));
}

void ApproveExportCtx77da62_DisconnectClicked(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(qint32)>(&ApproveExportCtx77da62::clicked), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(qint32)>(&ApproveExportCtx77da62::Signal_Clicked));
}

void ApproveExportCtx77da62_Clicked(void* ptr, int b)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->clicked(b);
}

void ApproveExportCtx77da62_ConnectBack(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)()>(&ApproveExportCtx77da62::back), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)()>(&ApproveExportCtx77da62::Signal_Back));
}

void ApproveExportCtx77da62_DisconnectBack(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)()>(&ApproveExportCtx77da62::back), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)()>(&ApproveExportCtx77da62::Signal_Back));
}

void ApproveExportCtx77da62_Back(void* ptr)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->back();
}

void ApproveExportCtx77da62_ConnectPasswordEdited(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::passwordEdited), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_PasswordEdited));
}

void ApproveExportCtx77da62_DisconnectPasswordEdited(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::passwordEdited), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_PasswordEdited));
}

void ApproveExportCtx77da62_PasswordEdited(void* ptr, struct Moc_PackedString b)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->passwordEdited(QString::fromUtf8(b.data, b.len));
}

struct Moc_PackedString ApproveExportCtx77da62_Remote(void* ptr)
{
	return ({ QByteArray te5e769 = static_cast<ApproveExportCtx77da62*>(ptr)->remote().toUtf8(); Moc_PackedString { const_cast<char*>(te5e769.prepend("WHITESPACE").constData()+10), te5e769.size()-10 }; });
}

struct Moc_PackedString ApproveExportCtx77da62_RemoteDefault(void* ptr)
{
	return ({ QByteArray t2a5a65 = static_cast<ApproveExportCtx77da62*>(ptr)->remoteDefault().toUtf8(); Moc_PackedString { const_cast<char*>(t2a5a65.prepend("WHITESPACE").constData()+10), t2a5a65.size()-10 }; });
}

void ApproveExportCtx77da62_SetRemote(void* ptr, struct Moc_PackedString remote)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setRemote(QString::fromUtf8(remote.data, remote.len));
}

void ApproveExportCtx77da62_SetRemoteDefault(void* ptr, struct Moc_PackedString remote)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setRemoteDefault(QString::fromUtf8(remote.data, remote.len));
}

void ApproveExportCtx77da62_ConnectRemoteChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::remoteChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_RemoteChanged));
}

void ApproveExportCtx77da62_DisconnectRemoteChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::remoteChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_RemoteChanged));
}

void ApproveExportCtx77da62_RemoteChanged(void* ptr, struct Moc_PackedString remote)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->remoteChanged(QString::fromUtf8(remote.data, remote.len));
}

struct Moc_PackedString ApproveExportCtx77da62_Transport(void* ptr)
{
	return ({ QByteArray t0a1db1 = static_cast<ApproveExportCtx77da62*>(ptr)->transport().toUtf8(); Moc_PackedString { const_cast<char*>(t0a1db1.prepend("WHITESPACE").constData()+10), t0a1db1.size()-10 }; });
}

struct Moc_PackedString ApproveExportCtx77da62_TransportDefault(void* ptr)
{
	return ({ QByteArray t71afda = static_cast<ApproveExportCtx77da62*>(ptr)->transportDefault().toUtf8(); Moc_PackedString { const_cast<char*>(t71afda.prepend("WHITESPACE").constData()+10), t71afda.size()-10 }; });
}

void ApproveExportCtx77da62_SetTransport(void* ptr, struct Moc_PackedString transport)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setTransport(QString::fromUtf8(transport.data, transport.len));
}

void ApproveExportCtx77da62_SetTransportDefault(void* ptr, struct Moc_PackedString transport)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setTransportDefault(QString::fromUtf8(transport.data, transport.len));
}

void ApproveExportCtx77da62_ConnectTransportChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::transportChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_TransportChanged));
}

void ApproveExportCtx77da62_DisconnectTransportChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::transportChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_TransportChanged));
}

void ApproveExportCtx77da62_TransportChanged(void* ptr, struct Moc_PackedString transport)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->transportChanged(QString::fromUtf8(transport.data, transport.len));
}

struct Moc_PackedString ApproveExportCtx77da62_Endpoint(void* ptr)
{
	return ({ QByteArray tfa38c8 = static_cast<ApproveExportCtx77da62*>(ptr)->endpoint().toUtf8(); Moc_PackedString { const_cast<char*>(tfa38c8.prepend("WHITESPACE").constData()+10), tfa38c8.size()-10 }; });
}

struct Moc_PackedString ApproveExportCtx77da62_EndpointDefault(void* ptr)
{
	return ({ QByteArray t8bfb73 = static_cast<ApproveExportCtx77da62*>(ptr)->endpointDefault().toUtf8(); Moc_PackedString { const_cast<char*>(t8bfb73.prepend("WHITESPACE").constData()+10), t8bfb73.size()-10 }; });
}

void ApproveExportCtx77da62_SetEndpoint(void* ptr, struct Moc_PackedString endpoint)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setEndpoint(QString::fromUtf8(endpoint.data, endpoint.len));
}

void ApproveExportCtx77da62_SetEndpointDefault(void* ptr, struct Moc_PackedString endpoint)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setEndpointDefault(QString::fromUtf8(endpoint.data, endpoint.len));
}

void ApproveExportCtx77da62_ConnectEndpointChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::endpointChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_EndpointChanged));
}

void ApproveExportCtx77da62_DisconnectEndpointChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::endpointChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_EndpointChanged));
}

void ApproveExportCtx77da62_EndpointChanged(void* ptr, struct Moc_PackedString endpoint)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->endpointChanged(QString::fromUtf8(endpoint.data, endpoint.len));
}

struct Moc_PackedString ApproveExportCtx77da62_Address(void* ptr)
{
	return ({ QByteArray ta698ee = static_cast<ApproveExportCtx77da62*>(ptr)->address().toUtf8(); Moc_PackedString { const_cast<char*>(ta698ee.prepend("WHITESPACE").constData()+10), ta698ee.size()-10 }; });
}

struct Moc_PackedString ApproveExportCtx77da62_AddressDefault(void* ptr)
{
	return ({ QByteArray tb92461 = static_cast<ApproveExportCtx77da62*>(ptr)->addressDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tb92461.prepend("WHITESPACE").constData()+10), tb92461.size()-10 }; });
}

void ApproveExportCtx77da62_SetAddress(void* ptr, struct Moc_PackedString address)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setAddress(QString::fromUtf8(address.data, address.len));
}

void ApproveExportCtx77da62_SetAddressDefault(void* ptr, struct Moc_PackedString address)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setAddressDefault(QString::fromUtf8(address.data, address.len));
}

void ApproveExportCtx77da62_ConnectAddressChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::addressChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_AddressChanged));
}

void ApproveExportCtx77da62_DisconnectAddressChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::addressChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_AddressChanged));
}

void ApproveExportCtx77da62_AddressChanged(void* ptr, struct Moc_PackedString address)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->addressChanged(QString::fromUtf8(address.data, address.len));
}

struct Moc_PackedString ApproveExportCtx77da62_Password(void* ptr)
{
	return ({ QByteArray tad39f3 = static_cast<ApproveExportCtx77da62*>(ptr)->password().toUtf8(); Moc_PackedString { const_cast<char*>(tad39f3.prepend("WHITESPACE").constData()+10), tad39f3.size()-10 }; });
}

struct Moc_PackedString ApproveExportCtx77da62_PasswordDefault(void* ptr)
{
	return ({ QByteArray td3a6c1 = static_cast<ApproveExportCtx77da62*>(ptr)->passwordDefault().toUtf8(); Moc_PackedString { const_cast<char*>(td3a6c1.prepend("WHITESPACE").constData()+10), td3a6c1.size()-10 }; });
}

void ApproveExportCtx77da62_SetPassword(void* ptr, struct Moc_PackedString password)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setPassword(QString::fromUtf8(password.data, password.len));
}

void ApproveExportCtx77da62_SetPasswordDefault(void* ptr, struct Moc_PackedString password)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setPasswordDefault(QString::fromUtf8(password.data, password.len));
}

void ApproveExportCtx77da62_ConnectPasswordChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::passwordChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_PasswordChanged));
}

void ApproveExportCtx77da62_DisconnectPasswordChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::passwordChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_PasswordChanged));
}

void ApproveExportCtx77da62_PasswordChanged(void* ptr, struct Moc_PackedString password)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->passwordChanged(QString::fromUtf8(password.data, password.len));
}

struct Moc_PackedString ApproveExportCtx77da62_FromSrc(void* ptr)
{
	return ({ QByteArray t6c4e9b = static_cast<ApproveExportCtx77da62*>(ptr)->fromSrc().toUtf8(); Moc_PackedString { const_cast<char*>(t6c4e9b.prepend("WHITESPACE").constData()+10), t6c4e9b.size()-10 }; });
}

struct Moc_PackedString ApproveExportCtx77da62_FromSrcDefault(void* ptr)
{
	return ({ QByteArray t8c3db3 = static_cast<ApproveExportCtx77da62*>(ptr)->fromSrcDefault().toUtf8(); Moc_PackedString { const_cast<char*>(t8c3db3.prepend("WHITESPACE").constData()+10), t8c3db3.size()-10 }; });
}

void ApproveExportCtx77da62_SetFromSrc(void* ptr, struct Moc_PackedString fromSrc)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setFromSrc(QString::fromUtf8(fromSrc.data, fromSrc.len));
}

void ApproveExportCtx77da62_SetFromSrcDefault(void* ptr, struct Moc_PackedString fromSrc)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->setFromSrcDefault(QString::fromUtf8(fromSrc.data, fromSrc.len));
}

void ApproveExportCtx77da62_ConnectFromSrcChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::fromSrcChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_FromSrcChanged));
}

void ApproveExportCtx77da62_DisconnectFromSrcChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::fromSrcChanged), static_cast<ApproveExportCtx77da62*>(ptr), static_cast<void (ApproveExportCtx77da62::*)(QString)>(&ApproveExportCtx77da62::Signal_FromSrcChanged));
}

void ApproveExportCtx77da62_FromSrcChanged(void* ptr, struct Moc_PackedString fromSrc)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->fromSrcChanged(QString::fromUtf8(fromSrc.data, fromSrc.len));
}

int ApproveExportCtx77da62_ApproveExportCtx77da62_QRegisterMetaType()
{
	return qRegisterMetaType<ApproveExportCtx77da62*>();
}

int ApproveExportCtx77da62_ApproveExportCtx77da62_QRegisterMetaType2(char* typeName)
{
	return qRegisterMetaType<ApproveExportCtx77da62*>(const_cast<const char*>(typeName));
}

int ApproveExportCtx77da62_ApproveExportCtx77da62_QmlRegisterType()
{
#ifdef QT_QML_LIB
	return qmlRegisterType<ApproveExportCtx77da62>();
#else
	return 0;
#endif
}

int ApproveExportCtx77da62_ApproveExportCtx77da62_QmlRegisterType2(char* uri, int versionMajor, int versionMinor, char* qmlName)
{
#ifdef QT_QML_LIB
	return qmlRegisterType<ApproveExportCtx77da62>(const_cast<const char*>(uri), versionMajor, versionMinor, const_cast<const char*>(qmlName));
#else
	return 0;
#endif
}

void* ApproveExportCtx77da62___dynamicPropertyNames_atList(void* ptr, int i)
{
	return new QByteArray(({QByteArray tmp = static_cast<QList<QByteArray>*>(ptr)->at(i); if (i == static_cast<QList<QByteArray>*>(ptr)->size()-1) { static_cast<QList<QByteArray>*>(ptr)->~QList(); free(ptr); }; tmp; }));
}

void ApproveExportCtx77da62___dynamicPropertyNames_setList(void* ptr, void* i)
{
	static_cast<QList<QByteArray>*>(ptr)->append(*static_cast<QByteArray*>(i));
}

void* ApproveExportCtx77da62___dynamicPropertyNames_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QByteArray>();
}

void* ApproveExportCtx77da62___findChildren_atList2(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveExportCtx77da62___findChildren_setList2(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveExportCtx77da62___findChildren_newList2(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* ApproveExportCtx77da62___findChildren_atList3(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveExportCtx77da62___findChildren_setList3(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveExportCtx77da62___findChildren_newList3(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* ApproveExportCtx77da62___findChildren_atList(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveExportCtx77da62___findChildren_setList(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveExportCtx77da62___findChildren_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* ApproveExportCtx77da62___children_atList(void* ptr, int i)
{
	return ({QObject * tmp = static_cast<QList<QObject *>*>(ptr)->at(i); if (i == static_cast<QList<QObject *>*>(ptr)->size()-1) { static_cast<QList<QObject *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveExportCtx77da62___children_setList(void* ptr, void* i)
{
	static_cast<QList<QObject *>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveExportCtx77da62___children_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject *>();
}

void* ApproveExportCtx77da62_NewApproveExportCtx(void* parent)
{
	if (dynamic_cast<QCameraImageCapture*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QCameraImageCapture*>(parent));
	} else if (dynamic_cast<QDBusPendingCallWatcher*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QDBusPendingCallWatcher*>(parent));
	} else if (dynamic_cast<QExtensionFactory*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QExtensionFactory*>(parent));
	} else if (dynamic_cast<QExtensionManager*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QExtensionManager*>(parent));
	} else if (dynamic_cast<QGraphicsObject*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QGraphicsObject*>(parent));
	} else if (dynamic_cast<QGraphicsWidget*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QGraphicsWidget*>(parent));
	} else if (dynamic_cast<QLayout*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QLayout*>(parent));
	} else if (dynamic_cast<QMediaPlaylist*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QMediaPlaylist*>(parent));
	} else if (dynamic_cast<QMediaRecorder*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QMediaRecorder*>(parent));
	} else if (dynamic_cast<QOffscreenSurface*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QOffscreenSurface*>(parent));
	} else if (dynamic_cast<QPaintDeviceWindow*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QPaintDeviceWindow*>(parent));
	} else if (dynamic_cast<QPdfWriter*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QPdfWriter*>(parent));
	} else if (dynamic_cast<QQuickItem*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QQuickItem*>(parent));
	} else if (dynamic_cast<QRadioData*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QRadioData*>(parent));
	} else if (dynamic_cast<QWidget*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QWidget*>(parent));
	} else if (dynamic_cast<QWindow*>(static_cast<QObject*>(parent))) {
		return new ApproveExportCtx77da62(static_cast<QWindow*>(parent));
	} else {
		return new ApproveExportCtx77da62(static_cast<QObject*>(parent));
	}
}

void ApproveExportCtx77da62_DestroyApproveExportCtx(void* ptr)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->~ApproveExportCtx77da62();
}

void ApproveExportCtx77da62_DestroyApproveExportCtxDefault(void* ptr)
{
	Q_UNUSED(ptr);

}

char ApproveExportCtx77da62_EventDefault(void* ptr, void* e)
{
	return static_cast<ApproveExportCtx77da62*>(ptr)->QObject::event(static_cast<QEvent*>(e));
}

char ApproveExportCtx77da62_EventFilterDefault(void* ptr, void* watched, void* event)
{
	return static_cast<ApproveExportCtx77da62*>(ptr)->QObject::eventFilter(static_cast<QObject*>(watched), static_cast<QEvent*>(event));
}

void ApproveExportCtx77da62_ChildEventDefault(void* ptr, void* event)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->QObject::childEvent(static_cast<QChildEvent*>(event));
}

void ApproveExportCtx77da62_ConnectNotifyDefault(void* ptr, void* sign)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->QObject::connectNotify(*static_cast<QMetaMethod*>(sign));
}

void ApproveExportCtx77da62_CustomEventDefault(void* ptr, void* event)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->QObject::customEvent(static_cast<QEvent*>(event));
}

void ApproveExportCtx77da62_DeleteLaterDefault(void* ptr)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->QObject::deleteLater();
}

void ApproveExportCtx77da62_DisconnectNotifyDefault(void* ptr, void* sign)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->QObject::disconnectNotify(*static_cast<QMetaMethod*>(sign));
}

void ApproveExportCtx77da62_TimerEventDefault(void* ptr, void* event)
{
	static_cast<ApproveExportCtx77da62*>(ptr)->QObject::timerEvent(static_cast<QTimerEvent*>(event));
}



void ApproveImportCtx77da62_ConnectClicked(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(qint32)>(&ApproveImportCtx77da62::clicked), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(qint32)>(&ApproveImportCtx77da62::Signal_Clicked));
}

void ApproveImportCtx77da62_DisconnectClicked(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(qint32)>(&ApproveImportCtx77da62::clicked), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(qint32)>(&ApproveImportCtx77da62::Signal_Clicked));
}

void ApproveImportCtx77da62_Clicked(void* ptr, int b)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->clicked(b);
}

void ApproveImportCtx77da62_ConnectBack(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)()>(&ApproveImportCtx77da62::back), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)()>(&ApproveImportCtx77da62::Signal_Back));
}

void ApproveImportCtx77da62_DisconnectBack(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)()>(&ApproveImportCtx77da62::back), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)()>(&ApproveImportCtx77da62::Signal_Back));
}

void ApproveImportCtx77da62_Back(void* ptr)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->back();
}

void ApproveImportCtx77da62_ConnectPasswordEdited(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::passwordEdited), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_PasswordEdited));
}

void ApproveImportCtx77da62_DisconnectPasswordEdited(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::passwordEdited), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_PasswordEdited));
}

void ApproveImportCtx77da62_PasswordEdited(void* ptr, struct Moc_PackedString b)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->passwordEdited(QString::fromUtf8(b.data, b.len));
}

void ApproveImportCtx77da62_ConnectConfirmPasswordEdited(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::confirmPasswordEdited), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_ConfirmPasswordEdited));
}

void ApproveImportCtx77da62_DisconnectConfirmPasswordEdited(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::confirmPasswordEdited), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_ConfirmPasswordEdited));
}

void ApproveImportCtx77da62_ConfirmPasswordEdited(void* ptr, struct Moc_PackedString b)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->confirmPasswordEdited(QString::fromUtf8(b.data, b.len));
}

void ApproveImportCtx77da62_ConnectOldPasswordEdited(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::oldPasswordEdited), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_OldPasswordEdited));
}

void ApproveImportCtx77da62_DisconnectOldPasswordEdited(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::oldPasswordEdited), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_OldPasswordEdited));
}

void ApproveImportCtx77da62_OldPasswordEdited(void* ptr, struct Moc_PackedString b)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->oldPasswordEdited(QString::fromUtf8(b.data, b.len));
}

struct Moc_PackedString ApproveImportCtx77da62_Remote(void* ptr)
{
	return ({ QByteArray tf0cf2b = static_cast<ApproveImportCtx77da62*>(ptr)->remote().toUtf8(); Moc_PackedString { const_cast<char*>(tf0cf2b.prepend("WHITESPACE").constData()+10), tf0cf2b.size()-10 }; });
}

struct Moc_PackedString ApproveImportCtx77da62_RemoteDefault(void* ptr)
{
	return ({ QByteArray tec1c2d = static_cast<ApproveImportCtx77da62*>(ptr)->remoteDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tec1c2d.prepend("WHITESPACE").constData()+10), tec1c2d.size()-10 }; });
}

void ApproveImportCtx77da62_SetRemote(void* ptr, struct Moc_PackedString remote)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setRemote(QString::fromUtf8(remote.data, remote.len));
}

void ApproveImportCtx77da62_SetRemoteDefault(void* ptr, struct Moc_PackedString remote)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setRemoteDefault(QString::fromUtf8(remote.data, remote.len));
}

void ApproveImportCtx77da62_ConnectRemoteChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::remoteChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_RemoteChanged));
}

void ApproveImportCtx77da62_DisconnectRemoteChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::remoteChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_RemoteChanged));
}

void ApproveImportCtx77da62_RemoteChanged(void* ptr, struct Moc_PackedString remote)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->remoteChanged(QString::fromUtf8(remote.data, remote.len));
}

struct Moc_PackedString ApproveImportCtx77da62_Transport(void* ptr)
{
	return ({ QByteArray tadac4a = static_cast<ApproveImportCtx77da62*>(ptr)->transport().toUtf8(); Moc_PackedString { const_cast<char*>(tadac4a.prepend("WHITESPACE").constData()+10), tadac4a.size()-10 }; });
}

struct Moc_PackedString ApproveImportCtx77da62_TransportDefault(void* ptr)
{
	return ({ QByteArray t8a7036 = static_cast<ApproveImportCtx77da62*>(ptr)->transportDefault().toUtf8(); Moc_PackedString { const_cast<char*>(t8a7036.prepend("WHITESPACE").constData()+10), t8a7036.size()-10 }; });
}

void ApproveImportCtx77da62_SetTransport(void* ptr, struct Moc_PackedString transport)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setTransport(QString::fromUtf8(transport.data, transport.len));
}

void ApproveImportCtx77da62_SetTransportDefault(void* ptr, struct Moc_PackedString transport)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setTransportDefault(QString::fromUtf8(transport.data, transport.len));
}

void ApproveImportCtx77da62_ConnectTransportChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::transportChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_TransportChanged));
}

void ApproveImportCtx77da62_DisconnectTransportChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::transportChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_TransportChanged));
}

void ApproveImportCtx77da62_TransportChanged(void* ptr, struct Moc_PackedString transport)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->transportChanged(QString::fromUtf8(transport.data, transport.len));
}

struct Moc_PackedString ApproveImportCtx77da62_Endpoint(void* ptr)
{
	return ({ QByteArray t1c8c49 = static_cast<ApproveImportCtx77da62*>(ptr)->endpoint().toUtf8(); Moc_PackedString { const_cast<char*>(t1c8c49.prepend("WHITESPACE").constData()+10), t1c8c49.size()-10 }; });
}

struct Moc_PackedString ApproveImportCtx77da62_EndpointDefault(void* ptr)
{
	return ({ QByteArray tbdd7d9 = static_cast<ApproveImportCtx77da62*>(ptr)->endpointDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tbdd7d9.prepend("WHITESPACE").constData()+10), tbdd7d9.size()-10 }; });
}

void ApproveImportCtx77da62_SetEndpoint(void* ptr, struct Moc_PackedString endpoint)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setEndpoint(QString::fromUtf8(endpoint.data, endpoint.len));
}

void ApproveImportCtx77da62_SetEndpointDefault(void* ptr, struct Moc_PackedString endpoint)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setEndpointDefault(QString::fromUtf8(endpoint.data, endpoint.len));
}

void ApproveImportCtx77da62_ConnectEndpointChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::endpointChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_EndpointChanged));
}

void ApproveImportCtx77da62_DisconnectEndpointChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::endpointChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_EndpointChanged));
}

void ApproveImportCtx77da62_EndpointChanged(void* ptr, struct Moc_PackedString endpoint)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->endpointChanged(QString::fromUtf8(endpoint.data, endpoint.len));
}

struct Moc_PackedString ApproveImportCtx77da62_OldPassword(void* ptr)
{
	return ({ QByteArray t5bb522 = static_cast<ApproveImportCtx77da62*>(ptr)->oldPassword().toUtf8(); Moc_PackedString { const_cast<char*>(t5bb522.prepend("WHITESPACE").constData()+10), t5bb522.size()-10 }; });
}

struct Moc_PackedString ApproveImportCtx77da62_OldPasswordDefault(void* ptr)
{
	return ({ QByteArray tc68d0a = static_cast<ApproveImportCtx77da62*>(ptr)->oldPasswordDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tc68d0a.prepend("WHITESPACE").constData()+10), tc68d0a.size()-10 }; });
}

void ApproveImportCtx77da62_SetOldPassword(void* ptr, struct Moc_PackedString oldPassword)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setOldPassword(QString::fromUtf8(oldPassword.data, oldPassword.len));
}

void ApproveImportCtx77da62_SetOldPasswordDefault(void* ptr, struct Moc_PackedString oldPassword)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setOldPasswordDefault(QString::fromUtf8(oldPassword.data, oldPassword.len));
}

void ApproveImportCtx77da62_ConnectOldPasswordChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::oldPasswordChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_OldPasswordChanged));
}

void ApproveImportCtx77da62_DisconnectOldPasswordChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::oldPasswordChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_OldPasswordChanged));
}

void ApproveImportCtx77da62_OldPasswordChanged(void* ptr, struct Moc_PackedString oldPassword)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->oldPasswordChanged(QString::fromUtf8(oldPassword.data, oldPassword.len));
}

struct Moc_PackedString ApproveImportCtx77da62_Password(void* ptr)
{
	return ({ QByteArray t6314e7 = static_cast<ApproveImportCtx77da62*>(ptr)->password().toUtf8(); Moc_PackedString { const_cast<char*>(t6314e7.prepend("WHITESPACE").constData()+10), t6314e7.size()-10 }; });
}

struct Moc_PackedString ApproveImportCtx77da62_PasswordDefault(void* ptr)
{
	return ({ QByteArray tf1c22b = static_cast<ApproveImportCtx77da62*>(ptr)->passwordDefault().toUtf8(); Moc_PackedString { const_cast<char*>(tf1c22b.prepend("WHITESPACE").constData()+10), tf1c22b.size()-10 }; });
}

void ApproveImportCtx77da62_SetPassword(void* ptr, struct Moc_PackedString password)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setPassword(QString::fromUtf8(password.data, password.len));
}

void ApproveImportCtx77da62_SetPasswordDefault(void* ptr, struct Moc_PackedString password)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setPasswordDefault(QString::fromUtf8(password.data, password.len));
}

void ApproveImportCtx77da62_ConnectPasswordChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::passwordChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_PasswordChanged));
}

void ApproveImportCtx77da62_DisconnectPasswordChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::passwordChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_PasswordChanged));
}

void ApproveImportCtx77da62_PasswordChanged(void* ptr, struct Moc_PackedString password)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->passwordChanged(QString::fromUtf8(password.data, password.len));
}

struct Moc_PackedString ApproveImportCtx77da62_ConfirmPassword(void* ptr)
{
	return ({ QByteArray tef3480 = static_cast<ApproveImportCtx77da62*>(ptr)->confirmPassword().toUtf8(); Moc_PackedString { const_cast<char*>(tef3480.prepend("WHITESPACE").constData()+10), tef3480.size()-10 }; });
}

struct Moc_PackedString ApproveImportCtx77da62_ConfirmPasswordDefault(void* ptr)
{
	return ({ QByteArray t250338 = static_cast<ApproveImportCtx77da62*>(ptr)->confirmPasswordDefault().toUtf8(); Moc_PackedString { const_cast<char*>(t250338.prepend("WHITESPACE").constData()+10), t250338.size()-10 }; });
}

void ApproveImportCtx77da62_SetConfirmPassword(void* ptr, struct Moc_PackedString confirmPassword)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setConfirmPassword(QString::fromUtf8(confirmPassword.data, confirmPassword.len));
}

void ApproveImportCtx77da62_SetConfirmPasswordDefault(void* ptr, struct Moc_PackedString confirmPassword)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->setConfirmPasswordDefault(QString::fromUtf8(confirmPassword.data, confirmPassword.len));
}

void ApproveImportCtx77da62_ConnectConfirmPasswordChanged(void* ptr)
{
	QObject::connect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::confirmPasswordChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_ConfirmPasswordChanged));
}

void ApproveImportCtx77da62_DisconnectConfirmPasswordChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::confirmPasswordChanged), static_cast<ApproveImportCtx77da62*>(ptr), static_cast<void (ApproveImportCtx77da62::*)(QString)>(&ApproveImportCtx77da62::Signal_ConfirmPasswordChanged));
}

void ApproveImportCtx77da62_ConfirmPasswordChanged(void* ptr, struct Moc_PackedString confirmPassword)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->confirmPasswordChanged(QString::fromUtf8(confirmPassword.data, confirmPassword.len));
}

int ApproveImportCtx77da62_ApproveImportCtx77da62_QRegisterMetaType()
{
	return qRegisterMetaType<ApproveImportCtx77da62*>();
}

int ApproveImportCtx77da62_ApproveImportCtx77da62_QRegisterMetaType2(char* typeName)
{
	return qRegisterMetaType<ApproveImportCtx77da62*>(const_cast<const char*>(typeName));
}

int ApproveImportCtx77da62_ApproveImportCtx77da62_QmlRegisterType()
{
#ifdef QT_QML_LIB
	return qmlRegisterType<ApproveImportCtx77da62>();
#else
	return 0;
#endif
}

int ApproveImportCtx77da62_ApproveImportCtx77da62_QmlRegisterType2(char* uri, int versionMajor, int versionMinor, char* qmlName)
{
#ifdef QT_QML_LIB
	return qmlRegisterType<ApproveImportCtx77da62>(const_cast<const char*>(uri), versionMajor, versionMinor, const_cast<const char*>(qmlName));
#else
	return 0;
#endif
}

void* ApproveImportCtx77da62___dynamicPropertyNames_atList(void* ptr, int i)
{
	return new QByteArray(({QByteArray tmp = static_cast<QList<QByteArray>*>(ptr)->at(i); if (i == static_cast<QList<QByteArray>*>(ptr)->size()-1) { static_cast<QList<QByteArray>*>(ptr)->~QList(); free(ptr); }; tmp; }));
}

void ApproveImportCtx77da62___dynamicPropertyNames_setList(void* ptr, void* i)
{
	static_cast<QList<QByteArray>*>(ptr)->append(*static_cast<QByteArray*>(i));
}

void* ApproveImportCtx77da62___dynamicPropertyNames_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QByteArray>();
}

void* ApproveImportCtx77da62___findChildren_atList2(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveImportCtx77da62___findChildren_setList2(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveImportCtx77da62___findChildren_newList2(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* ApproveImportCtx77da62___findChildren_atList3(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveImportCtx77da62___findChildren_setList3(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveImportCtx77da62___findChildren_newList3(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* ApproveImportCtx77da62___findChildren_atList(void* ptr, int i)
{
	return ({QObject* tmp = static_cast<QList<QObject*>*>(ptr)->at(i); if (i == static_cast<QList<QObject*>*>(ptr)->size()-1) { static_cast<QList<QObject*>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveImportCtx77da62___findChildren_setList(void* ptr, void* i)
{
	static_cast<QList<QObject*>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveImportCtx77da62___findChildren_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject*>();
}

void* ApproveImportCtx77da62___children_atList(void* ptr, int i)
{
	return ({QObject * tmp = static_cast<QList<QObject *>*>(ptr)->at(i); if (i == static_cast<QList<QObject *>*>(ptr)->size()-1) { static_cast<QList<QObject *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}

void ApproveImportCtx77da62___children_setList(void* ptr, void* i)
{
	static_cast<QList<QObject *>*>(ptr)->append(static_cast<QObject*>(i));
}

void* ApproveImportCtx77da62___children_newList(void* ptr)
{
	Q_UNUSED(ptr);
	return new QList<QObject *>();
}

void* ApproveImportCtx77da62_NewApproveImportCtx(void* parent)
{
	if (dynamic_cast<QCameraImageCapture*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QCameraImageCapture*>(parent));
	} else if (dynamic_cast<QDBusPendingCallWatcher*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QDBusPendingCallWatcher*>(parent));
	} else if (dynamic_cast<QExtensionFactory*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QExtensionFactory*>(parent));
	} else if (dynamic_cast<QExtensionManager*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QExtensionManager*>(parent));
	} else if (dynamic_cast<QGraphicsObject*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QGraphicsObject*>(parent));
	} else if (dynamic_cast<QGraphicsWidget*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QGraphicsWidget*>(parent));
	} else if (dynamic_cast<QLayout*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QLayout*>(parent));
	} else if (dynamic_cast<QMediaPlaylist*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QMediaPlaylist*>(parent));
	} else if (dynamic_cast<QMediaRecorder*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QMediaRecorder*>(parent));
	} else if (dynamic_cast<QOffscreenSurface*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QOffscreenSurface*>(parent));
	} else if (dynamic_cast<QPaintDeviceWindow*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QPaintDeviceWindow*>(parent));
	} else if (dynamic_cast<QPdfWriter*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QPdfWriter*>(parent));
	} else if (dynamic_cast<QQuickItem*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QQuickItem*>(parent));
	} else if (dynamic_cast<QRadioData*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QRadioData*>(parent));
	} else if (dynamic_cast<QWidget*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QWidget*>(parent));
	} else if (dynamic_cast<QWindow*>(static_cast<QObject*>(parent))) {
		return new ApproveImportCtx77da62(static_cast<QWindow*>(parent));
	} else {
		return new ApproveImportCtx77da62(static_cast<QObject*>(parent));
	}
}

void ApproveImportCtx77da62_DestroyApproveImportCtx(void* ptr)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->~ApproveImportCtx77da62();
}

void ApproveImportCtx77da62_DestroyApproveImportCtxDefault(void* ptr)
{
	Q_UNUSED(ptr);

}

char ApproveImportCtx77da62_EventDefault(void* ptr, void* e)
{
	return static_cast<ApproveImportCtx77da62*>(ptr)->QObject::event(static_cast<QEvent*>(e));
}

char ApproveImportCtx77da62_EventFilterDefault(void* ptr, void* watched, void* event)
{
	return static_cast<ApproveImportCtx77da62*>(ptr)->QObject::eventFilter(static_cast<QObject*>(watched), static_cast<QEvent*>(event));
}

void ApproveImportCtx77da62_ChildEventDefault(void* ptr, void* event)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->QObject::childEvent(static_cast<QChildEvent*>(event));
}

void ApproveImportCtx77da62_ConnectNotifyDefault(void* ptr, void* sign)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->QObject::connectNotify(*static_cast<QMetaMethod*>(sign));
}

void ApproveImportCtx77da62_CustomEventDefault(void* ptr, void* event)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->QObject::customEvent(static_cast<QEvent*>(event));
}

void ApproveImportCtx77da62_DeleteLaterDefault(void* ptr)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->QObject::deleteLater();
}

void ApproveImportCtx77da62_DisconnectNotifyDefault(void* ptr, void* sign)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->QObject::disconnectNotify(*static_cast<QMetaMethod*>(sign));
}

void ApproveImportCtx77da62_TimerEventDefault(void* ptr, void* event)
{
	static_cast<ApproveImportCtx77da62*>(ptr)->QObject::timerEvent(static_cast<QTimerEvent*>(event));
}



void ApproveListingCtx77da62_ConnectClicked(void* ptr)
{
	QObject::connect(static_cast<ApproveListingCtx77da62*>(ptr), static_cast<void (ApproveListingCtx77da62::*)(qint32)>(&ApproveListingCtx77da62::clicked), static_cast<ApproveListingCtx77da62*>(ptr), static_cast<void (ApproveListingCtx77da62::*)(qint32)>(&ApproveListingCtx77da62::Signal_Clicked));
}

void ApproveListingCtx77da62_DisconnectClicked(void* ptr)
{
	QObject::disconnect(static_cast<ApproveListingCtx77da62*>(ptr), static_cast<void (ApproveListingCtx77da62::*)(qint32)>(&ApproveListingCtx77da62::clicked), static_cast<ApproveListingCtx77da62*>(ptr), static_cast<void (ApproveListingCtx77da62::*)(qint32)>(&ApproveListingCtx77da62::Signal_Clicked));
}

void ApproveListingCtx77da62_Clicked(void* ptr, int b)
{
	static_cast<ApproveListingCtx77da62*>(ptr)->clicked(b);
}
...
void ApproveTxCtx77da62_ConnectClicked(void* ptr)
{
	QObject::connect(static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qint32)>(&ApproveTxCtx77da62::clicked), static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qint32)>(&ApproveTxCtx77da62::Signal_Clicked));
}

void ApproveTxCtx77da62_DisconnectClicked(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qint32)>(&ApproveTxCtx77da62::clicked), static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qint32)>(&ApproveTxCtx77da62::Signal_Clicked));
}

void ApproveTxCtx77da62_Clicked(void* ptr, int b)
{
	static_cast<ApproveTxCtx77da62*>(ptr)->clicked(b);
}
...
double ApproveTxCtx77da62_ValueUnit(void* ptr)
{
	return static_cast<ApproveTxCtx77da62*>(ptr)->valueUnit();
}

double ApproveTxCtx77da62_ValueUnitDefault(void* ptr)
{
	return static_cast<ApproveTxCtx77da62*>(ptr)->valueUnitDefault();
}

void ApproveTxCtx77da62_SetValueUnit(void* ptr, double valueUnit)
{
	static_cast<ApproveTxCtx77da62*>(ptr)->setValueUnit(valueUnit);
}

void ApproveTxCtx77da62_SetValueUnitDefault(void* ptr, double valueUnit)
{
...
{
	QObject::connect(static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::valueUnitChanged), static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::Signal_ValueUnitChanged));
}

void ApproveTxCtx77da62_DisconnectValueUnitChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::valueUnitChanged), static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::Signal_ValueUnitChanged));
}

void ApproveTxCtx77da62_ValueUnitChanged(void* ptr, double valueUnit)
{
...
double ApproveTxCtx77da62_GasPriceUnit(void* ptr)
{
	return static_cast<ApproveTxCtx77da62*>(ptr)->gasPriceUnit();
}

double ApproveTxCtx77da62_GasPriceUnitDefault(void* ptr)
{
	return static_cast<ApproveTxCtx77da62*>(ptr)->gasPriceUnitDefault();
}

void ApproveTxCtx77da62_SetGasPriceUnit(void* ptr, double gasPriceUnit)
{
	static_cast<ApproveTxCtx77da62*>(ptr)->setGasPriceUnit(gasPriceUnit);
}

void ApproveTxCtx77da62_SetGasPriceUnitDefault(void* ptr, double gasPriceUnit)
{
...
{
	QObject::connect(static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::gasPriceUnitChanged), static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::Signal_GasPriceUnitChanged));
}

void ApproveTxCtx77da62_DisconnectGasPriceUnitChanged(void* ptr)
{
	QObject::disconnect(static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::gasPriceUnitChanged), static_cast<ApproveTxCtx77da62*>(ptr), static_cast<void (ApproveTxCtx77da62::*)(qreal)>(&ApproveTxCtx77da62::Signal_GasPriceUnitChanged));
}

void ApproveTxCtx77da62_GasPriceUnitChanged(void* ptr, double gasPriceUnit)
{
...
void ApproveSignDataCtx77da62_ConnectBack(void* ptr)
{
	QObject::connect(static_cast<ApproveSignDataCtx77da62*>(ptr), static_cast<void (ApproveSignDataCtx77da62::*)()>(&ApproveSignDataCtx77da62::back), static_cast<ApproveSignDataCtx77da62*>(ptr), static_cast<void (ApproveSignDataCtx77da62::*)()>(&ApproveSignDataCtx77da62::Signal_Back));
}

void ApproveSignDataCtx77da62_DisconnectBack(void* ptr)
{
	QObject::disconnect(static_cast<ApproveSignDataCtx77da62*>(ptr), static_cast<void (ApproveSignDataCtx77da62::*)()>(&ApproveSignDataCtx77da62::back), static_cast<ApproveSignDataCtx77da62*>(ptr), static_cast<void (ApproveSignDataCtx77da62::*)()>(&ApproveSignDataCtx77da62::Signal_Back));
}

void ApproveSignDataCtx77da62_Back(void* ptr)
{
	static_cast<ApproveSignDataCtx77da62*>(ptr)->back();
}
